...
const socialLinks = [
  {
    href: 'https://github.com/Vaamanikam11',
        ...
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            ...
            <div className="mb-12 lg:mb-0 lg:flex-col">
                ...
                <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch] reveal-up">
                    I love building smart, impactful software. Reach out if you're looking to collaborate on something exciting!
                </p>
            ...
            <form
                action="https://getform.io/f/bgdljoda"
                method="POST"
                ...
                <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            autoComplete="email"
                            required
                            placeholder="vaamanikam11@gmail.com"
                            className="text-field reveal-up"
                        />
                    </div>
